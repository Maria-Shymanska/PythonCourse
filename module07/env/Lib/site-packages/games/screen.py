...
class Screen:
    ...
    def __init__(self, border=None, fps=30, debug=False):
        ...
        self.colors = {"white": None, "rainbow": self.COLOR_RAINBOW}
        self.rainbow_colors = []
    ...
    def remove(self, *screen_objects):
        ...
        for screen_object in screen_objects:
            ...
            if (
                screen_object
                and self.controller
                and screen_object in self.controller.key_listeners
            ):
    ...
    def render(self, curses_screen, screen: Screen):
            ...
            for y in range(self.height):
                if self.buffer[y][x] != self.screen[y][x]:
                    ...
                    if char:
                        ...
                        curses_screen.addch(
                            y, x, "."
                        )  # Need to write something before erasing to work 100%
                        blanks.add((y, x))
        ...
        if blanks:
            for y, x in blanks:
                curses_screen.addch(
                    y, x, " "
                )  # for macBook Pro console, otherwise some artifacts are left behind.
            curses_screen.refresh()
